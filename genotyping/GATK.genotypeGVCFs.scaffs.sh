#!/bin/bash
#SBATCH --output=DHPgenotypeGVCFs_shortscaff.%A_%a.out
#SBATCH --error=DHPgenotypeGVCFs_shortscaff.%A_%a.err
...
-V gendb://$gDBImport_FOLDER/DHP_database_DHP.chrom.scaffs.list \
-O $GVCF_FOLDER/DHP_short_scaffs.joint.gt.vcf.gz
