#!/bin/bash
#SBATCH --output=postBQSR_DHPgenotypeGVCFs_shortscaff.%A_%a.out
#SBATCH --error=postBQSR_DHPgenotypeGVCFs_shortscaff.%A_%a.err
...
-V gendb://$gDBImport_FOLDER/DHP_postBQSR_database_DHP.chrom.scaffs.list \
-O $GVCF_FOLDER/DHP.postBQSR.short_scaffs.joint.gt.vcf.gz
